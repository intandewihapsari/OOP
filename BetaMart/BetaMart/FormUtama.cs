...
namespace BetaMart
{
    public partial class FormUtama : Form
    {
        ...
        private void btntambah_Click(object sender, EventArgs e)
        {
            ...
            {
                koneksi.Open();
                string perintah = "insert into barang (nama,kode,harga,stok,tgl_masuk) values('" + tbnama.Text + "','" + tbkode.Text + "','" + tbharga.Text + "','" + tbstok.Text + "','" + tbtanggalmasuk.Text + "')";
        ...
        private void btnedit_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string perintah = "update barang set nama='" + tbnama.Text + "' ,stok='" + tbstok.Text + "',kode='" + tbkode.Text + "' ,harga='" + tbharga.Text + "' ,tgl_masuk='" + tbtanggalmasuk.Text + "' where ID=" + tbid.Text + "";
